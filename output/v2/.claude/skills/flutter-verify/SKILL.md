---
name: flutter-verify
description: "Flutter 프로젝트 pre-completion 검증. dart analyze, format, test coverage, build, golden, SAST, dep audit 통과 확인."
---
...
# 7. SAST scan
semgrep scan --config auto lib/
# Expected: 0 findings (skip if semgrep not installed)

# 8. Dependency audit
dart pub outdated
# Expected: no major/critical updates pending
```
...
```json
{
  ...
  "steps": [
    ...
    {"name": "golden_test", "passed": true},
    {"name": "semgrep", "passed": true, "findings": 0},
    {"name": "dep_audit", "passed": true, "outdated": 2}
  ]
}
```
